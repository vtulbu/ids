 ...
 */
export const fluidValue = (property: string, maxValue: string | number, minValue: string | number, maxViewportWidth: string | number, minViewportWidth: string | number): string => `
